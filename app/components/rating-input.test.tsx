...
describe('RatingInput', () => {
  ...
  it('selects "Good (+1)" when defaultValue is 1', () => {
    render(
      <RatingInput name="testRating" label="Test Rating" defaultValue={1} />,
    )
  ...
  it('selects "Medium (0)" when defaultValue is 0', () => {
    render(
      <RatingInput name="testRating" label="Test Rating" defaultValue={0} />,
    )
  ...
  it('selects "Not Rated" when defaultValue is null', () => {
    render(
      <RatingInput name="testRating" label="Test Rating" defaultValue={null} />,
    )
  ...
  it('passes name prop to RadioGroup for form submission', () => {
    const { container } = render(
      <RatingInput name="ratingImpact" label="Impact" defaultValue={1} />,
    )
  ...
  it('generates unique IDs based on name prop', () => {
    ...
    expect(screen.getByLabelText('Good (+1)')).toHaveAttribute(
      'id',
      'myRating-good',
    )
    expect(screen.getByLabelText('Medium (0)')).toHaveAttribute(
      'id',
      'myRating-medium',
    )
    expect(screen.getByLabelText('Bad (-1)')).toHaveAttribute(
      'id',
      'myRating-bad',
    )
    expect(screen.getByLabelText('Not Rated')).toHaveAttribute(
      'id',
      'myRating-unrated',
    )
  })
